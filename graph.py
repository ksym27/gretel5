...
class Graph:
    ...
    def get_nx_graph(self, index) -> nx.DiGraph():
        _, n_blockage_steps = self.blockage.size()
        n_graph = len(self.nx_graphs)
        n_steps = n_blockage_steps / n_graph
        return self.nx_graphs[int(index / n_steps)]
